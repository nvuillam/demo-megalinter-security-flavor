...
docker run --rm -v "$ROOT_FOLDER:/tmp/lint" -e SARIF_REPORTER_FILE_NAME="$SARIF_REPORTER_FILE_NAME" -e LOG_LEVEL=DEBUG -e REPOSITORY_GITLEAKS_ARGUMENTS='--log-level warn' "$DOCKER_IMAGE"  
